...
const serviceAccount = require('./assignment-12-4f4b2-firebase-adminsdk-wmwrr-ee96f5d6ee.json');
...
async function run() {
    try {
        ...
        const database = client.db('car_genious');
        ...
        // app.put('/users/admin', verifyToken, async (req, res) => {
        //     const user = req.body;
        //     console.log('put',req.headers,user);
        //     const filter = { email: user.email };
        //     const updateDoc = { $set: { role: 'admin' } };
        //     const result = await usersCollection.updateOne(filter, updateDoc);
        //     res.json(result);
